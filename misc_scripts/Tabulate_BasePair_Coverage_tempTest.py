...
def analyze_one_sample(reference_fasta, ref_list, bamfile_name, window_size, sample_id):
    ...
    2018.12.04 This is the function I'm changing right now
    """
    alignment_class = Tabulate_BasePair_Coverage(reference_fasta, ref_list)
    alignment_class.extract_bam_entries(bamfile_name) # output 3 bam files in the same folder. You have these already
