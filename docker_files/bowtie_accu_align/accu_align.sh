...
offLimitRegions=$LOCAL/microbiome-data-analysis/misc_files/combined_excluded_regions_threshold9.bed
scriptFolder=$LOCAL/microbiome-data-analysis/bowtie_accu_align/scripts
